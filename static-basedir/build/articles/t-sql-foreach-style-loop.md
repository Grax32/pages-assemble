<html><body><p>Here is a simple pattern that I came up with for executing a ForEach style loop in t-sql against a set of data in T-SQL.<br />
<br /></p>
...
<p>SET @Enumerator = CURSOR LOCAL FAST_FORWARD FOR
select UserId
from Users
where IsActive = 1</p>
<p>OPEN @Enumerator</p>
...
if (@@FETCH_STATUS &lt;&gt; 0) break</p>
<p>exec dbo.DoSomething @id
end</p>
<p>CLOSE @Enumerator
DEALLOCATE @Enumerator</p>
</pre>
<br />
