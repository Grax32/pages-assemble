<html><body><p>As we discussed in our previous <a href="/articles/sql-server-timestamp-introduction">article</a>, the SQL Server timestamp/rowversion type (rowversion is an alias for timestamp) is
