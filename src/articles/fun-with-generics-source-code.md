...
<br />
My code from last night's presentation is at&nbsp;<span class="outdated-link">`https://sdrv.ms/11ESMSs`</span>. &nbsp;This is a Visual Studio 2012 project.<br />
<br />
<br />
For those of you that need a Visual Studio 2010 version of the generics sample code, this is from my Nebraska Code Camp presentation. &nbsp;It doesn't have a few of the things from my Lincoln .NET user's group presentation but hopefully still interesting. You can download the Visual Studio 2010 project from&nbsp;<span class="outdated-link">`https://sdrv.ms/15hAXYZ`</span><br />
